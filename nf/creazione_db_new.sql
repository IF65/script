...
CREATE TABLE IF NOT EXISTS @DB.`magazzino` (
...
CREATE TABLE IF NOT EXISTS @DB.`marche` (
...
CREATE TABLE IF NOT EXISTS @DB.`mondi` (
...
CREATE TABLE IF NOT EXISTS @DB.`settori` (
	`codice` varchar(20) NOT NULL DEFAULT '',
	`ordinamento` int(11) NOT NULL DEFAULT '0',
	`descrizione` varchar(255) NOT NULL DEFAULT '',
	`codice_mondo` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`reparti` (
	`codice` varchar(20) NOT NULL DEFAULT '',
	`ordinamento` int(11) NOT NULL DEFAULT '0',
	`descrizione` varchar(255) NOT NULL DEFAULT '',
	`codice_settore` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`famiglie` (
	`codice` varchar(20) NOT NULL DEFAULT '',
	`ordinamento` int(11) NOT NULL DEFAULT '0',
	`descrizione` varchar(255) NOT NULL DEFAULT '',
	`codice_reparto` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`sottofamiglie` (
	`codice` varchar(20) NOT NULL DEFAULT '',
	`ordinamento` int(11) NOT NULL DEFAULT '0',
	`descrizione` varchar(255) NOT NULL DEFAULT '',
	`codice_famiglia` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`ean` (
	`codice` varchar(7) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`righe_vendita` (
...
CREATE TABLE IF NOT EXISTS @DB.`scontrini` (
  `id_scontrino` varchar(32) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`margini` (
  `progressivo` varchar(36) NOT NULL DEFAULT '',
  `margine` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`progressivo`),
  KEY `progressivo` (`progressivo`,`margine`)
...
CREATE TABLE IF NOT EXISTS @DB. `giacenze` (
  `codice` varchar(7) NOT NULL DEFAULT '',
  `negozio` varchar(4) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`contributi` (
...
CREATE TABLE IF NOT EXISTS @DB.`arrivi` (
	`id` varchar(36) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`righe_arrivi` (
	`id` varchar(36) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`trasferimenti_in` (
...
CREATE TABLE IF NOT EXISTS @DB.`righe_trasferimenti_in` (
  `id` varchar(36) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`trasferimenti_out` (
  `link` varchar(36) NOT NULL DEFAULT '',
  `negozio_partenza` varchar(4) NOT NULL DEFAULT '',
  `negozio_arrivo` varchar(4) NOT NULL DEFAULT '',
  `numero_ddt` varchar(13) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`righe_trasferimenti_out` (
  `id` varchar(36) NOT NULL DEFAULT '',
  `link_trasferimento` varchar(36) NOT NULL DEFAULT '',
  `codice` varchar(7) NOT NULL DEFAULT '',
  `ean` varchar(13) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`diversi` (
  `link` varchar(36) NOT NULL DEFAULT '',
  `progressivo` varchar(36) NOT NULL DEFAULT '',
  `negozio` varchar(4) NOT NULL DEFAULT '',
  `data` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS @DB.`righe_diversi` (
  `progressivo` varchar(36) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS @DB.`giacenze_iniziali` (
  `codice` varchar(7) NOT NULL DEFAULT '',
  `negozio` varchar(4) NOT NULL DEFAULT '',
  `giacenza` float NOT NULL DEFAULT '0',
  `costo_medio` float NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS @DB.`log_invio_dati` (
...
CREATE TABLE IF NOT EXISTS @DB.`benefici` (
...
CREATE TABLE IF NOT EXISTS @DB.`venditori` (
...
DROP TABLE IF EXISTS @DB.`temp_stock`;
